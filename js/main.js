...
let espaceCitation = document.getElementById("citation");
let espaceAuteur = document.getElementById("auteur");

let btn = document.getElementById("nouveau");

let limit = citations.length;
...
let index = random();
espaceCitation.textContent = citations[index][0];
espaceAuteur.textContent = citations[index][1];
});